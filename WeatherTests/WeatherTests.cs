...
namespace WeatherTests
{
    ...
    public class WeatherTests
    {
        ...
        public void TestFahrenheitTemperatures()
        {
            ...
            Temperature boiling = new Temperature(212, TemperatureFormat.Fahrenheit);
        ...
        public void TestCelsiusTemperatures()
        {
            ...
            Assert.AreEqual(32, freezing.Fahrenheit, 0.01, "Freezing's fahrenheit temperature should be 32.");
            Assert.AreEqual(212, boiling.Fahrenheit, 0.01, "Boiling's fahrenheit temperature should be 212.");
        }
    }
}
